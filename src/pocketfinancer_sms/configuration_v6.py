"""Operation-bound grammar configuration layered over frozen v1-v5 assets."""
...
PROCESSING_CONFIG_CONTRACT_V6 = "pocketfinancer.processing-config/6"
NATIVE_INTEGRATION_RELEASE_V6 = "native-integration-v6"
...
def rollout_mode_for_stored_release(
    ...
    if release_id in {"native-integration-v5", NATIVE_INTEGRATION_RELEASE_V6}:
...
class ProcessingConfigSnapshotV6:
    operation_id: str
    ...
    contract: str = PROCESSING_CONFIG_CONTRACT_V6
    ...
    def __post_init__(self) -> None:
        ...
        if (
            self.release_id != NATIVE_INTEGRATION_RELEASE_V6
        ...
        if type(self.grammar_enabled) is not bool:
            raise ValueError("grammar setting must be a boolean")
        if self.contract != PROCESSING_CONFIG_CONTRACT_V6:
    ...
    def payload(self) -> dict[str, Any]:
        return {
            ...
            "extractor": {**self.extractor.to_dict(), "grammar_enabled": self.grammar_enabled},
            "persistence_policy": {
